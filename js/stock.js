...
function _renderStockShell(){
  ...
  pg.innerHTML =
    ...
    +     '<div style="font-size:14px;font-weight:700;color:#1e293b;margin-bottom:10px">➕ 입고 추가</div>'
    +     '<div style="display:flex;gap:8px;flex-wrap:wrap;align-items:end">'
    +       '<div><label style="font-size:11px;color:#6b7280">입고일</label><br>'
    +         '<input type="date" id="stIn_date" value="'+_stockToday()+'" class="fc" style="padding:6px 10px;width:140px"></div>'
    +       '<div><label style="font-size:11px;color:#6b7280">부위</label><br>'
    +         '<input type="text" id="stIn_type" placeholder="우둔/홍두깨/설도..." class="fc" style="padding:6px 10px;width:140px"></div>'
    +       '<div><label style="font-size:11px;color:#6b7280">박스 수</label><br>'
    +         '<input type="number" id="stIn_boxes" placeholder="0" class="fc" style="padding:6px 10px;width:100px;text-align:right"></div>'
    +       '<div style="flex:1;min-width:160px"><label style="font-size:11px;color:#6b7280">메모(원산지/로트 등)</label><br>'
    +         '<input type="text" id="stIn_note" placeholder="(선택)" class="fc" style="padding:6px 10px;width:100%"></div>'
    +       '<button class="btn bp" onclick="stockAdd()" style="padding:8px 16px">저장</button>'
    +     '</div>'
    +     '<div style="font-size:11px;color:#9ca3af;margin-top:8px">※ 초기 재고도 "입고"로 입력하세요. 예) 2026-05-01 우둔 247박스 (메모: 초기재고)</div>'
    +   '</div>'
    ...
    +         '<th style="padding:10px 12px;text-align:center;font-weight:600;color:#475569;border-bottom:1px solid #e5e7eb;width:140px">관리</th>'
    +       '</tr></thead>'
